...
describe('createReduxForm', function () {
  ...
  var Passthrough = function (_Component2) {
    ...
    Passthrough.prototype.render = function render() {
  ...
  it('should pass fields as props', function () {
    ...
    var stub = _testUtils2.default.findRenderedComponentWithType(dom, Form);
  ...
  it('should call onSubmit prop', function (done) {
    ...
    var formElement = _testUtils2.default.findRenderedDOMComponentWithTag(dom, 'form');

    _testUtils2.default.Simulate.submit(formElement);
  });
  ...
  it('should only initialize on mount once', function () {
    ...
    var dom2 = _testUtils2.default.renderIntoDocument(_react2.default.createElement(
      _reactRedux.Provider,
      { store: store },
      _react2.default.createElement(Decorated, { initialValues: { name: 'Bob' } })
    ));
    var stub2 = _testUtils2.default.findRenderedComponentWithType(dom2, Form);
  ...
  it('should provide a submit() method to submit the form', function () {
    ...
    var onSubmit = (0, _expect.createSpy)().andCall(function (values, dispatch, props) {
      (0, _expect2.default)(values).toEqual(initialValues);
      (0, _expect2.default)(dispatch).toEqual(store.dispatch);
      (0, _expect2.default)(props.testProp).toEqual(1337);
    ...
    var Container = function (_Component11) {
      ...
      Container.prototype.render = function render() {
        return _react2.default.createElement(
          'div',
          null,
          _react2.default.createElement(Decorated, { ref: 'myForm', testProp: 1337 }),
          _react2.default.createElement(
            'button',
    ...
    (0, _expect2.default)(onSubmit).toHaveBeenCalled();
  });
  ...
  it('submitting from parent should fail if sync validation errors', function () {
    ...
    var Container = function (_Component12) {
      ...
      function Container(props) {
        ...
        var _this12 = _possibleConstructorReturn(this, _Component12.call(this, props));
  ...
  it('should only rerender the form that changed', function () {
    ...
    var fooStub = _testUtils2.default.findRenderedComponentWithType(dom, FooForm);
  ...
  it('should only rerender the field components that change', function () {
    ...
    var stub = _testUtils2.default.findRenderedComponentWithType(dom, FieldTestForm);
  ...
  it('should throw when trying to access the wrapped instance if withRef is not specified', function () {
    ...
    var Container = function (_Component19) {
      ...
      function Container() {
        ...
        return _possibleConstructorReturn(this, _Component19.apply(this, arguments));
      }

      Container.prototype.render = function render() {
        return _react2.default.createElement(Passthrough, null);
      };
    ...
    var decorated = _testUtils2.default.findRenderedComponentWithType(dom, DecoratedForm);
    (0, _expect2.default)(function () {
  ...
  it('should return the instance of the wrapped component for use in calling child methods', function () {
    ...
    var Container = function (_Component20) {
      ...
      function Container() {
        ...
        return _possibleConstructorReturn(this, _Component20.apply(this, arguments));
      }

      Container.prototype.someInstanceMethod = function someInstanceMethod() {
        return someData;
      };
    ...
    (0, _expect2.default)(decorated.getWrappedInstance().someInstanceMethod()).toBe(someData);
    (0, _expect2.default)(decorated.refs.wrappedInstance.refs.wrappedInstance.getWrappedInstance().refs.wrappedInstance.someInstanceMethod()).toBe(someData);
  });
  ...
  it('should change nested fields', function () {
    ...
    var FormComponent = function (_Component21) {
      ...
      function FormComponent() {
        ...
        return _possibleConstructorReturn(this, _Component21.apply(this, arguments));
      }

      FormComponent.prototype.UNSAFE_componentWillReceiveProps = function UNSAFE_componentWillReceiveProps(nextProps) {
        /*
         console.info(
    ...
    var stub = _testUtils2.default.findRenderedComponentWithType(dom, FormComponent);
  ...
  it('pass correct initial values to validate when initialValues not given', function () {
    ...
    var validate = function validate(values) {
      (0, _expect2.default)(values.name).toBe(undefined);
      (0, _expect2.default)(values.company.name).toBe('Foo');
    };
    ...
    var ValidateTestForm = function (_Component22) {
      ...
      function ValidateTestForm() {
        ...
        return _possibleConstructorReturn(this, _Component22.apply(this, arguments));
      }

      ValidateTestForm.prototype.render = function render() {
